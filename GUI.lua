...
do
    function Library.new(info)
        ...
        local function makeLoader()
            ...
            Converted["_Title2"].Text = "Steel Hub"
        ...
        local function makeLibrary()
            ...
            Converted["_B"].Text = "Script by family_aks" -- please don't remove this, this is open sourced and I leave this here so that users can know the name of the UI library if they are interested in it
            ...
            Converted["_A"].Text = "AWP: family_aks"
...
print("Steel GUI v"..VERSION.." by family_aks")
